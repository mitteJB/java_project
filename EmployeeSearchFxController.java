...
public class EmployeeSearchFxController extends BorderPane {
    ...
    private void edit2(boolean b) {
        ...
        //tfmanagerid.setEditable(b);
        if (b) {
            tffirstname.setStyle("-fx-background-color: #968390");
            tflastname.setStyle("-fx-background-color: #968390");
            tfemail.setStyle("-fx-background-color: #968390");
            tfhiredate.setStyle("-fx-background-color: #968390");
            tfphone.setStyle("-fx-background-color: #968390");
